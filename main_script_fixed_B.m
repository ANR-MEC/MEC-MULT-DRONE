    ...
    for t = 1:size(main_task{m},2)
        ...
        while tol > max_tol && iteration <= max_iter
            ...
            while tol_alg1 > max_tol && iteration_alg1 <= max_iter_alg1
                ...
                [q_op, d_op_square, prob4_output, fval] = prob4_function_fixed_B(params, l_op, p_op, m_op, B_op, x0);     
                fval4 = fval;
        ...
        save(['fixed_B_prob2_output_', new_date, '.mat'], 'prob2_output_list')
        save(['fixed_B_prob4_output_', new_date, '.mat'], 'prob4_output_list')
        save(['fixed_B_params_', new_date, '.mat'], 'params')
